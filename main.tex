...
Discard all but a few representative sample paths through $F$ to optimize performance \cite{WestessonEtAl2012}
...
This can be extended to models that partition the alignment into regions, like phylo-grammars \cite{WestessonHolmes2012}
