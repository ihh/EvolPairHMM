...
We seek a model where the sequence can be partitioned into different zones (e.g. a low-indel hydrophobic region).
We also want to describe how the arrangement of zones itself evolves.

We hypothesize a grammar over {\em characters}, {\em links}, and {\em zones}:
\begin{itemize}
