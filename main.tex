...
\item
The probability that it is a block of type $j$ is $\rho_i \upsilon_{ij}$.
\end{itemize}
...
A block of type $i$ generates link types $j,k$ with probability $\kappa_{ijk}$.
