...
Or maybe they don't buy us much that just working with $P$ instead of $Q$ (since $A,B,F,P$ are all bounded in the range $[0,1]$),
and multiplying through by $1/(1+S)$ and $1/(1+D)$ for stability, would have. Hmmm.
