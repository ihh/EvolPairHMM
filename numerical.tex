...
$\Psi \subseteq \Phi$ are the end states, and
$\tau:\Phi \times \gappedalphabet \times \gappedalphabet \times \Phi \to \Re$ is the transition weight function ($\epsilon$ is the empty string).
