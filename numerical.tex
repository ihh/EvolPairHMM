...
%  & = &
%  \left( {\bf I} - {\bf J} \otimes {\bf U}_0
%  - {\bf J} \otimes {\bf U}_\theta \delta_\theta
%  - {\bf J} \otimes {\bf U}_t \delta_t
%  - {\bf J} \otimes {\bf U}_{\theta t} \delta_\theta \delta_t
%  + O(\delta_\theta^2) + O(\delta_t^2)
%  \right)^{-1} \\
%  & = &
%  \left(
%  \left( {\bf I} - {\bf J} \otimes {\bf U}_0 \right)
%  \left( {\bf I}
%  - {\bf V}_0 \left( {\bf J} \otimes {\bf U}_\theta \delta_\theta
%  + {\bf J} \otimes {\bf U}_t \delta_t
%  + {\bf J} \otimes {\bf U}_{\theta t} \delta_\theta \delta_t
%  \right) \right)
%  + O(\delta_\theta^2) + O(\delta_t^2)
...
%  & = &
%  {\bf V}_0
%  + {\bf V}_0 \left( {\bf J} \otimes {\bf U}_\theta \right) {\bf V}_0 \delta_\theta
%  + {\bf V}_0 \left( {\bf J} \otimes {\bf U}_t \right) {\bf V}_0 \delta_t
%  + {\bf V}_0 \left( {\bf J} \otimes {\bf U}_{\theta t} \right) {\bf V}_0 \delta_\theta \delta_t
%  + O(\delta_\theta^2) + O(\delta_t^2) \\
