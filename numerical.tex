...
Thus
\begin{eqnarray*}
  \frac{da}{dt} & = & \frac{\mu (1-y) b F}{S - y(S-b-q D)} - (\lambda +\mu ) a \\
  \frac{db}{dt} & = & -\frac{\mu (b+q D) b}{S - y(S-b-q D)} + \lambda (1-b) \\
  \frac{dF}{dt} & = & -\frac{\mu (b+q D) F}{S - y(S-b-q D)} + \lambda a \\
  \frac{dq}{dt} & = & \frac{1}{D} \left( \frac{\mu (b+q D) (S-q D)}{S - y(S-b-q D)} - \frac{q \lambda(D+1)}{1-y} \right) \\
  S & = & \exp\left(\frac{\lambda t}{1-x}\right)-1 \\
  D & = & \exp\left(\frac{\mu t}{1-y}\right)-1
\end{eqnarray*}
...
Or
\begin{eqnarray*}
  \frac{da}{dt} & = & \frac{\mu (1-y) b F L M}{M(1-L) - y(M(1-L-bL)-qL(1-M))} - (\lambda +\mu ) a \\
  \frac{db}{dt} & = & -\frac{\mu (bM+q(1-M)) b L}{M(1-L) - y(M(1-L-bL)-qL(1-M))} + \lambda (1-b) \\
  \frac{dF}{dt} & = & -\frac{\mu (bM+q(1-M)) F L}{M(1-L) - y(M(1-L-bL)-qL(1-M))} + \lambda a \\
  \frac{dq}{dt} & = & \frac{1}{1-M} \left( \frac{\mu (bM+q(1-M)) (M(1-L)-qL(1-M))}{M(1-L) - y(M(1-L-bL)-qL(1-M))} - \frac{q}{1-y} \right) \\
